...
import sty from './PlasmicMaPeinturePro.module.css' // plasmic-import: gm2WwyNce5_/css

export type PlasmicMaPeinturePro__VariantMembers = {}
export type PlasmicMaPeinturePro__VariantsArgs = {}
type VariantPropType = keyof PlasmicMaPeinturePro__VariantsArgs
export const PlasmicMaPeinturePro__VariantProps = new Array<VariantPropType>()

export type PlasmicMaPeinturePro__ArgsType = {}
type ArgPropType = keyof PlasmicMaPeinturePro__ArgsType
export const PlasmicMaPeinturePro__ArgProps = new Array<ArgPropType>()

export type PlasmicMaPeinturePro__OverridesType = {
  root?: p.Flex<'div'>
...
export interface DefaultMaPeintureProProps {}
...
function PlasmicMaPeinturePro__RenderFunc(props: {
  variants: PlasmicMaPeinturePro__VariantsArgs
  args: PlasmicMaPeinturePro__ArgsType
  overrides: PlasmicMaPeinturePro__OverridesType
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicMaPeinturePro.pageMetadata.title}</title>
        <meta key="og:title" property="og:title" content={PlasmicMaPeinturePro.pageMetadata.title} />
        <meta key="twitter:title" name="twitter:title" content={PlasmicMaPeinturePro.pageMetadata.title} />
      </Head>
...
type NodeOverridesType<T extends NodeNameType> = Pick<PlasmicMaPeinturePro__OverridesType, DescendantsType<T>>
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicMaPeinturePro__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<PlasmicMaPeinturePro__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicMaPeinturePro__ArgProps,
          internalVariantPropNames: PlasmicMaPeinturePro__VariantProps,
        }),
      [props, nodeName]
    )

    return PlasmicMaPeinturePro__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName,
  ...
  if (nodeName === 'root') {
    func.displayName = 'PlasmicMaPeinturePro'
  } else {
    func.displayName = `PlasmicMaPeinturePro.${nodeName}`
  }
  return func
}

export const PlasmicMaPeinturePro = Object.assign(
  // Top-level PlasmicMaPeinturePro renders the root element
  makeNodeComponent('root'),
  {
    ...
    // Metadata about props expected for PlasmicMaPeinturePro
    internalVariantProps: PlasmicMaPeinturePro__VariantProps,
    internalArgProps: PlasmicMaPeinturePro__ArgProps,
...
export default PlasmicMaPeinturePro
/* prettier-ignore-end */
