...
import sty from './PlasmicCountingTheDays2.module.css' // plasmic-import: uAr1Xy8mWfn/css
...
export type PlasmicCountingTheDays2__VariantMembers = {}
export type PlasmicCountingTheDays2__VariantsArgs = {}
type VariantPropType = keyof PlasmicCountingTheDays2__VariantsArgs
export const PlasmicCountingTheDays2__VariantProps = new Array<VariantPropType>()

export type PlasmicCountingTheDays2__ArgsType = {}
type ArgPropType = keyof PlasmicCountingTheDays2__ArgsType
export const PlasmicCountingTheDays2__ArgProps = new Array<ArgPropType>()

export type PlasmicCountingTheDays2__OverridesType = {
  root?: p.Flex<'div'>
...
export interface DefaultCountingTheDays2Props {}
...
function PlasmicCountingTheDays2__RenderFunc(props: {
  variants: PlasmicCountingTheDays2__VariantsArgs
  args: PlasmicCountingTheDays2__ArgsType
  overrides: PlasmicCountingTheDays2__OverridesType
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicCountingTheDays2.pageMetadata.title}</title>
        <meta key="og:title" property="og:title" content={PlasmicCountingTheDays2.pageMetadata.title} />
        <meta key="twitter:title" name="twitter:title" content={PlasmicCountingTheDays2.pageMetadata.title} />
        <meta key="description" name="description" content={PlasmicCountingTheDays2.pageMetadata.description} />
        <meta key="og:description" property="og:description" content={PlasmicCountingTheDays2.pageMetadata.description} />
        <meta key="twitter:description" name="twitter:description" content={PlasmicCountingTheDays2.pageMetadata.description} />
        <meta key="og:image" property="og:image" content={PlasmicCountingTheDays2.pageMetadata.ogImageSrc} />
        <meta key="twitter:image" name="twitter:image" content={PlasmicCountingTheDays2.pageMetadata.ogImageSrc} />
      </Head>
        ...
        <div
          ...
          {true ? (
            <div data-plasmic-name={'price'} data-plasmic-override={overrides.price} className={classNames(projectcss.all, sty.price)}>
              <div className={classNames(projectcss.all, projectcss.__wab_text, sty.text___3AAib)}>{'8 000 €'}</div>
...
type NodeOverridesType<T extends NodeNameType> = Pick<PlasmicCountingTheDays2__OverridesType, DescendantsType<T>>
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCountingTheDays2__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<PlasmicCountingTheDays2__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCountingTheDays2__ArgProps,
          internalVariantPropNames: PlasmicCountingTheDays2__VariantProps,
        }),
      [props, nodeName]
    )

    return PlasmicCountingTheDays2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName,
  ...
  if (nodeName === 'root') {
    func.displayName = 'PlasmicCountingTheDays2'
  } else {
    func.displayName = `PlasmicCountingTheDays2.${nodeName}`
  }
  return func
}

export const PlasmicCountingTheDays2 = Object.assign(
  // Top-level PlasmicCountingTheDays2 renders the root element
  makeNodeComponent('root'),
  {
    ...
    // Metadata about props expected for PlasmicCountingTheDays2
    internalVariantProps: PlasmicCountingTheDays2__VariantProps,
    internalArgProps: PlasmicCountingTheDays2__ArgProps,
...
export default PlasmicCountingTheDays2
/* prettier-ignore-end */
