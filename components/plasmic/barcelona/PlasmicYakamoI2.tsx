          ...
          {(hasVariant(globalVariants, 'screen', 'mobileOnly') ? true : true) ? (
            <div className={classNames(projectcss.all, sty.freeBox__xjL5)}>
              ...
              <h5 className={classNames(projectcss.all, projectcss.h5, projectcss.__wab_text, sty.h5__luAV)}>
                {
                  'Code RGB : R123 G47 B97\n\n12 NFT numérotés à 3 600 euros pièce.\n\nNFT comprenant utilisation de cette teinte dans les METAVERSE , sur tous supports + 300 m2 de la peinture révolutionnaire HYBRIDE #12 de la marque française THE BLACK TOWER COMPANY.'
                }
              </h5>
