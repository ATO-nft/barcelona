        ...
        <div
          ...
          {(hasVariant(globalVariants, 'screen', 'mobileOnly') ? true : true) ? (
            <div className={classNames(projectcss.all, sty.freeBox__r7Dc)}>
              ...
              <h4 className={classNames(projectcss.all, projectcss.h4, projectcss.__wab_text, sty.h4__pf71N)}>
                <React.Fragment>
              ...
              <h5 className={classNames(projectcss.all, projectcss.h5, projectcss.__wab_text, sty.h5___2GVnb)}>
                {
              ...
              {true ? (
                <div className={classNames(projectcss.all, sty.freeBox__dwVs1)}>
                  {true ? (
                    <div className={classNames(projectcss.all, sty.freeBox__lRsQd)}>
                      <div className={classNames(projectcss.all, projectcss.__wab_text, sty.text__izAiy)}>
                        <React.Fragment>
                      ...
                      <h4 className={classNames(projectcss.all, projectcss.h4, projectcss.__wab_text, sty.h4__fRx0W)}>{'Physical artwork'}</h4>
                    </div>
                  ) : null}
                  {(hasVariant(globalVariants, 'screen', 'mobileOnly') ? true : true) ? (
                    <p.PlasmicImg
              ...
              {true ? (
                <h5 className={classNames(projectcss.all, projectcss.h5, projectcss.__wab_text, sty.h5__vPanN)}>
                  <React.Fragment>
              ...
              {true ? (
                <Reveal
                  ...
                  <BidButton data-plasmic-name={'buy'} data-plasmic-override={overrides.buy} className={classNames('__wab_instance', sty.buy)}>
                    <div className={classNames(projectcss.all, projectcss.__wab_text, sty.text__mRoI)}>{'Buy'}</div>
                  </BidButton>

                  <div className={classNames(projectcss.all, sty.freeBox__hbyw8)} />

                  {true ? (
                    <div className={classNames(projectcss.all, sty.freeBox___4WYhp)}>
                      {(hasVariant(globalVariants, 'screen', 'mobileOnly') ? true : true) ? (
                        <p.PlasmicImg
                          alt={''}
                      ...
                      {true ? (
                        <div className={classNames(projectcss.all, sty.freeBox__rUaTx)}>
                          <div className={classNames(projectcss.all, projectcss.__wab_text, sty.text__h6EUj)}>
                            <React.Fragment>
                              <span className={'plasmic_default__all plasmic_default__span'} style={{ fontWeight: 700 }}>
                                {'200 EUR'}
                              </span>
                          ...
                          <h4 className={classNames(projectcss.all, projectcss.h4, projectcss.__wab_text, sty.h4__l9AjB)}>{'Digital'}</h4>
                        </div>
                      ) : null}
                    </div>
                  ) : null}
          ...
          {(hasVariant(globalVariants, 'screen', 'mobileOnly') ? true : true) ? (
            <div className={classNames(projectcss.all, sty.freeBox__opWjf)}>
              ...
              <BidButton
                ...
                <div className={classNames(projectcss.all, projectcss.__wab_text, sty.text___5ZISj)}>{'Buy'}</div>
              </BidButton>
            </div>
          ) : null}
          ...
          <div data-plasmic-name={'footer'} data-plasmic-override={overrides.footer} className={classNames(projectcss.all, sty.footer)}>
            <div className={classNames(projectcss.all, sty.freeBox__uca5)}>
              <p.PlasmicLink
                className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link__nxrf5)}
                component={Link}
                platform={'nextjs'}>
                {hasVariant(globalVariants, 'screen', 'mobileOnly')
            ...
            {true ? (
              <div className={classNames(projectcss.all, sty.freeBox__sqSkk)}>
                <p.PlasmicLink
                  className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link__b5DTa)}
                  component={Link}
                  href={`/`}
                  platform={'nextjs'}>
                  {'Terms & conditions'}
                ...
                {(hasVariant(globalVariants, 'screen', 'mobileOnly') ? true : false) ? (
                  <p.PlasmicLink
                    className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link___7VgMg)}
                    component={Link}
                    platform={'nextjs'}>
                    {'Contact us'}
                  </p.PlasmicLink>
...
const PlasmicDescendants = {
  root: ['root', 'header', 'h1', 'reveal', 'buy', 'price', 'msgBox', 'nextId', 'next', 'bidButton', 'loader', 'footer'],
  header: ['header'],
  h1: ['h1'],
  reveal: ['reveal', 'buy'],
  buy: ['buy'],
