...
function PlasmicHeader__RenderFunc(props: {
  ...
  return (
    <div
      ...
      <div data-plasmic-name={'header'} data-plasmic-override={overrides.header} className={classNames(projectcss.all, sty.header)}>
        <div className={classNames(projectcss.all, sty.freeBox__xp3FU)}>
          <p.PlasmicLink
            className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link___4RTmb)}
            component={Link}
            href={`/`}
            platform={'nextjs'}>
            <React.Fragment>
        ...
        {true ? (
          <div className={classNames(projectcss.all, sty.freeBox__acZQq)}>
            ...
            <p.PlasmicLink
              className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link___53UeM)}
              component={Link}
              href={`/artist`}
              platform={'nextjs'}>
              {'Artists'}
            ...
            <p.PlasmicLink
              className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link__zKovz)}
              component={Link}
              href={`/vision`}
              platform={'nextjs'}>
              {'Vision'}
            ...
            <Button data-plasmic-name={'connect'} data-plasmic-override={overrides.connect} className={classNames('__wab_instance', sty.connect)}>
              {'Connect'}
            </Button>
          </div>
        ) : null}
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    /* Specify args directly as props*/ Omit<PlasmicHeader__ArgsType, ReservedPropsType> &
