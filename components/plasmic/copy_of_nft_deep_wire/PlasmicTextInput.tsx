...
import sty from './PlasmicTextInput.module.css' // plasmic-import: 61SGjYpCYdRMcz/css

import SearchsvgIcon from './icons/PlasmicIcon__Searchsvg' // plasmic-import: Z85Y7uePdggYLU/icon
...
export const PlasmicTextInput__VariantProps = new Array<VariantPropType>('showStartIcon', 'showEndIcon', 'isDisabled', 'color')
    ...
    <div
      ...
      {(hasVariant($state, 'showStartIcon', 'showStartIcon') ? true : true) ? (
        <div
          ...
          {p.renderPlasmicSlot({
            defaultContents: <SearchsvgIcon className={classNames(projectcss.all, sty.svg__wEeT0)} role={'img'} />,
      ...
      {(hasVariant($state, 'showEndIcon', 'showEndIcon') ? true : true) ? (
        <div
          ...
          {p.renderPlasmicSlot({
            defaultContents: <ChecksvgIcon className={classNames(projectcss.all, sty.svg__h6KwZ)} role={'img'} />,
