  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta key="twitter:title" name="twitter:title" content={PlasmicHomepage.pageMetadata.title} />
        <meta key="description" name="description" content={PlasmicHomepage.pageMetadata.description} />
        <meta key="og:description" property="og:description" content={PlasmicHomepage.pageMetadata.description} />
        <meta key="twitter:description" name="twitter:description" content={PlasmicHomepage.pageMetadata.description} />
      </Head>
        ...
        <p.Stack
          ...
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__v7KuC)}>
              {(hasVariant(globalVariants, 'screen', 'mobileOnly') ? true : true) ? (
                <h2 className={classNames(projectcss.all, projectcss.h2, projectcss.__wab_text, sty.h2__o4X4Z)}>
              ...
              {(hasVariant(globalVariants, 'screen', 'mobileOnly') ? true : false) ? (
                <h2 className={classNames(projectcss.all, projectcss.h2, projectcss.__wab_text, sty.h2__knXqw)}>
                  {hasVariant(globalVariants, 'screen', 'mobileOnly') ? (
                    <React.Fragment>
                      <span className={'plasmic_default__all plasmic_default__span'} style={{ color: '#FFFFFF' }}>
                        {'NFT Deep Wire'}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__bcYvj)}>
                <p.PlasmicLink
                  className={classNames(projectcss.all, projectcss.a, sty.link__krklt)}
                  component={Link}
                  href={`/jfe`}
                  platform={'nextjs'}>
                  <Reveal
                ...
                <p.PlasmicLink
                  className={classNames(projectcss.all, projectcss.a, sty.link___0Ghu3)}
                  component={Link}
                  href={`/shades`}
                  platform={'nextjs'}>
          ...
          <div data-plasmic-name={'footer'} data-plasmic-override={overrides.footer} className={classNames(projectcss.all, sty.footer)}>
            <div className={classNames(projectcss.all, sty.freeBox__v1MMn)}>
              <p.PlasmicLink
                className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link__z53C)}
                component={Link}
                platform={'nextjs'}>
                {hasVariant(globalVariants, 'screen', 'mobileOnly')
            ...
            {true ? (
              <div className={classNames(projectcss.all, sty.freeBox___6Qp0M)}>
                <p.PlasmicLink
                  className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link__rJbn2)}
                  component={Link}
                  href={`/`}
                  platform={'nextjs'}>
                  {'Terms & conditions'}
                ...
                {(hasVariant(globalVariants, 'screen', 'mobileOnly') ? true : false) ? (
                  <p.PlasmicLink
                    className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link___5L305)}
                    component={Link}
                    platform={'nextjs'}>
                    {'Contact us'}
                  </p.PlasmicLink>
