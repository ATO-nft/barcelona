    ...
    <div
      ...
      <div data-plasmic-name={'footer'} data-plasmic-override={overrides.footer} className={classNames(projectcss.all, sty.footer)}>
        <div className={classNames(projectcss.all, sty.freeBox__qqvHc)}>
          <p.PlasmicLink
            className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link__gnjlx)}
            component={Link}
            platform={'nextjs'}>
        ...
        {true ? (
          <div className={classNames(projectcss.all, sty.freeBox__n3M7B)}>
            ...
            {(hasVariant(globalVariants, 'screen', 'mobileOnly') ? true : false) ? (
              <p.PlasmicLink
                className={classNames(projectcss.all, projectcss.a, projectcss.__wab_text, sty.link__pqkKi)}
                component={Link}
                platform={'nextjs'}>
                {'Contact us'}
              </p.PlasmicLink>
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    /* Specify args directly as props*/ Omit<PlasmicFooter__ArgsType, ReservedPropsType> &
