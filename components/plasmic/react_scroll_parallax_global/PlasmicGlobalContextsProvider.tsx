...
export interface GlobalContextsProviderProps {
  ...
  parallaxProviderWrapperProps?: Partial<Omit<React.ComponentProps<typeof ParallaxProviderWrapper>, 'children'>>
}
...
export default function GlobalContextsProvider(props: GlobalContextsProviderProps) {
  ...
  return (
    <ParallaxProviderWrapper
      ...
      scrollAxis={
        parallaxProviderWrapperProps && 'scrollAxis' in parallaxProviderWrapperProps ? parallaxProviderWrapperProps.scrollAxis! : undefined
      }>
      {children}
    </ParallaxProviderWrapper>
  )
